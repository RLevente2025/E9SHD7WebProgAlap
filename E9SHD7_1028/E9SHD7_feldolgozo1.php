...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Név ellenőrzése
    if (!preg_match("/^[A-ZÁÉÍÖŐÜŰa-záéíóöőúüű ]{4,}$/u", $nev)) {
        $hibak[] = "A név formátuma hibás (legalább 4 karakter, csak betűk és szóköz megengedett).";
    }
